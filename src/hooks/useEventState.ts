...
export function useEventState() {
  ...
  const resetEvent = async () => {
    return updateEventState({
      ...
      pre_evento_lock_date: '2026-03-07T09:40:00-03:00',
      ao_vivo_enabled: false,
      ao_vivo_unlock_date: '2026-03-07T09:30:00-03:00',
      ao_vivo_lock_date: '2026-03-08T19:00:00-03:00',
      pos_evento_enabled: true,
      pos_evento_unlock_date: '2026-03-09T07:00:00-03:00',
